...
%         reorder             = randperm(104);
        ...
        BLOCKRETRIEVAL{reps(i)} = Retrieval_loopBaseline_block(listevents_type,...
            ...
            w,screenNumber,key,X,Y, PICdur, LIMITdur, IDLEdur);
    ...
    elseif conds(i) == 3
        ...
        BLOCKBASE{reps(i)} = Baseline_block(listevents_type,listevents_instance,InDoorImg,OutDoorImg,...
            ...
            screenNumber,key,X,Y, PICdur, LIMITdur, IDLEdur);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%% SUBFUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function BLOCKRETRIEVAL = Retrieval_loopBaseline_block(listevents_type,listevents_instance,Img,trial_indexes,screenYpixels,screenXpixels,w,screenNumber,key,X,Y, PICdur, LIMITdur, IDLEdur)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function BLOCKBASE = Baseline_block(listevents_type,listevents_instance,InDoorImg,OutDoorImg,tagoutdoor,tagindoor,trial_indexes,screenYpixels,screenXpixels,w,screenNumber,key,X,Y, PICdur, LIMITdur, IDLEdur)
