function MRI_ENCODING_RUN_supershort(ID, numrep)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%  MINI BLOCKS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
reorder_novel    = randperm(32);
reorder_repeat   = randperm(32);
reorder_baseline = randperm(32);
...
%         rand_out_img = randperm(length(fileListOutdoor));
        ...
        listevents_type     = [ones(1,24) ones(1,8).*2];
        listevents_instance = [ones(1,4).*1 ones(1,4).*2 ones(1,4).*3 ones(1,4).*4 ...
            ones(1,4).*5 ones(1,4).*6 ones(1,4).*1 ones(1,4).*2 ];
%         reorder             = randperm(48);
...
%         rand_out_img = randperm(length(fileListOutdoor));
        ...
        listevents = [ones(1,24) ones(1,8).*2];
